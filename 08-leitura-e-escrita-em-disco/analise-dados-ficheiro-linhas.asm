# =======================================================================================
# Titulo: Analise Estatistica e Ordenacao de Dados em Ficheiro (Quebra de Linha)
# Descricao: Leitura de ficheiro de texto contendo inteiros separados por quebra 
# de linha (newline). Realiza a extracao completa de caracteristicas estatisticas e 
# ordenacao bidirecional dos dados lidos para a memoria alocada.
# Analise de Computabilidade: Semelhante ao processamento por espacos, porem o AFD 
# de extracao lexica transita de estado perante os carateres de controlo de quebra 
# de linha (CR/LF). A decidibilidade e a complexidade mantem-se estritamente 
# dependentes do tamanho finito do ficheiro no disco, demonstrando na pratica o 
# mapeamento seguro entre armazenamento secundario e memoria primaria (RAM).
# Aplicacao: Importacao sequencial de registos de trafego de rede e analise em lote 
# (batch processing) para treino de modelos de aprendizado de maquina e avaliacao 
# de metricas de rede.
...
transporte_vetor:
	...
	beq $t0, 10, fim_numero		# Se for espaco
